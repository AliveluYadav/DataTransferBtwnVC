...
//self.detailsArray=[[NSMutableArray alloc]initWithObjects:self.firstNameRF.text, self.lastNameRF.text,self.ageRF.text,self.mobileNumRF.text,self.emailIdRF.text,self.whatsAppNumRF.text,self.usrNamRF.text,self.pswdRF.text,self.confPswdRF.text,self.btechPerRF.text,self.interPerRF.text,self.SSCPerRF.text,self.companyNamRF.text,self.addressRF.text,self.designtnRF.text,self.salaryRF.text, nil];
    ...
    self.detailsArray=[[NSMutableArray alloc]initWithObjects:
[[[[[[self.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0],
[[[[[[self.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:1],
[[[[[[self.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:2],
 [[[[[self.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:1],
[[[[[self.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:2],
[[[[[self.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:3],
[[[[self.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:1],
[[[[self.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:2],
[[[[self.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:3],
[[[self.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:1],
[[[self.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:2],
[[[self.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:3],
[[self.profArray objectAtIndex:0]objectAtIndex:1],
[[self.profArray objectAtIndex:0]objectAtIndex:2],
[[self.profArray objectAtIndex:0]objectAtIndex:3],
[[self.profArray objectAtIndex:0]objectAtIndex:4],nil];
